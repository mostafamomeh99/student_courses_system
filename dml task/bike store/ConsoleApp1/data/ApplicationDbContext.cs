...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.\\MYFIRSTSQLSERVER;Initial Catalog=Dml;User Id=sa;Password=6339782;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E272F871F93");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B415627172");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8521833A3C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962295496F07A");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4B4F06D06");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5B70FB520");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C2BF11DB9");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61647C12725D").IsUnique();

            entity.HasIndex(e => e.FirstName, "my_index");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3CC5E830E");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C4C4E93CB");
        ...
        {
            entity.HasKey(e => e.TaxId).HasName("PK__taxes__129B8670764DAB04");

            entity.ToTable("taxes", "sales");

            entity.HasIndex(e => e.State, "UQ__taxes__A9360BC39168C0E6").IsUnique();
